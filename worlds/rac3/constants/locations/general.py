...
class RAC3LOCATION:
    ...
    PHOENIX_HACKER = "Phoenix: VR: VR Gadget Training Reward 1"
    PHOENIX_HYPERSHOT = "Phoenix: VR: VR Gadget Training Reward 2"
    PHOENIX_VR_TRAINING = "Phoenix: VR: VR Gadget Training Complete"
    ...
    PHOENIX_VID_COMIC_1_HEALTH_UPGRADE = "Phoenix: Qwark VidComic 1 Health Upgrade"
    PHOENIX_VID_COMIC_2_CLEAR = "Phoenix: Qwark VidComic 2 Clear"
    PHOENIX_VID_COMIC_2_HEALTH_UPGRADE = "Phoenix: Qwark VidComic 2 Health Upgrade"
    PHOENIX_VID_COMIC_3_CLEAR = "Phoenix: Qwark VidComic 3 Clear"
    PHOENIX_VID_COMIC_3_HEALTH_UPGRADE = "Phoenix: Qwark VidComic 3 Health Upgrade"
    PHOENIX_VID_COMIC_4_CLEAR = "Phoenix: Qwark VidComic 4 Clear"
    PHOENIX_VID_COMIC_4_HEALTH_UPGRADE = "Phoenix: Qwark VidComic 4 Health Upgrade"
    PHOENIX_VID_COMIC_5_CLEAR = "Phoenix: Qwark VidComic 5 Clear"
    PHOENIX_VID_COMIC_5_HEALTH_UPGRADE = "Phoenix: Qwark VidComic 5 Health Upgrade"
    ...
    MARCADIA_REFRACTOR = "Marcadia: Start of Laser Defence Facility"
    MARCADIA_MEET_AL = "Marcadia: Meet Al"
    NATION_TYHRRA_GUISE = "Annihilation Nation: Grand Prize Bout Reward"
    NATION_GRAND_PRIZE_BOUT = "Annihilation Nation: Grand Prize Bout Complete"
    ...
    AQUATOS_BASE = "Aquatos: Infiltrate the Nefarious Base"
    ...
    ZELDRIN_STARPORT_BOX_BREAKER = "Zeldrin Starport: End of the Starport 2"
    ...
    METROPOLIS_MAP_O_MATIC = "Metropolis: Ranger Missions Complete"
    CRASH_SITE_NANO_PAK = "Crash Site: Gadget Under the Crashed Ship"
    CRASH_SITE_ESCAPE_POD = "Crash Site: Escape Pod"
    CRASH_SITE_INFOBOT_ARIDIA = "Crash Site: Rangers call for help"
    ARIDIA_WARP_PAD = "Aridia: Complete"
...
MISSION_COUNTS: dict[str, int] = {
    RAC3LOCATION.PHOENIX_VR_TRAINING: 0x00142765,
    RAC3LOCATION.PHOENIX_VR_WARM_UP: 0x00142766,
    RAC3LOCATION.PHOENIX_VR_D_L_D: 0x00142767,
    RAC3LOCATION.PHOENIX_VR_SPEED_ROUND: 0x00142768,
    RAC3LOCATION.PHOENIX_VR_HOT_STEPPER: 0x00142769,
    RAC3LOCATION.PHOENIX_VR_90_SECOND: 0x0014276A,
    RAC3LOCATION.PHOENIX_VR_SHOCKER: 0x0014276B,
    RAC3LOCATION.PHOENIX_VR_WRENCH: 0x0014276C,
    RAC3LOCATION.PHOENIX_VR_NERVES: 0x0014276D,

    RAC3LOCATION.MARCADIA_RANGERS_1: 0x00142738,
    RAC3LOCATION.MARCADIA_RANGERS_2: 0x00142739,
    RAC3LOCATION.MARCADIA_RANGERS_3: 0x0014273A,
    RAC3LOCATION.MARCADIA_RANGERS_4: 0x0014273B,
    RAC3LOCATION.MARCADIA_RANGERS_5: 0x0014273C,

    RAC3LOCATION.NATION_GRAND_PRIZE_BOUT: 0x0014276F,
    RAC3LOCATION.NATION_THE_TERRIBLE_TWO: 0x00142772,
    RAC3LOCATION.NATION_ROBOT_RAMPAGE: 0x00142773,
    RAC3LOCATION.NATION_TWO_MINUTE_WARNING: 0x00142774,
    RAC3LOCATION.NATION_90_SECONDS: 0x00142775,
    RAC3LOCATION.NATION_ONSLAUGHT: 0x00142776,
    RAC3LOCATION.NATION_WHIP_IT_GOOD: 0x00142777,
    RAC3LOCATION.NATION_HYDRA_N_SEEK: 0x00142778,
    RAC3LOCATION.NATION_CHAMPIONSHIP_BOUT: 0x00142779,
    RAC3LOCATION.NATION_MEET_COURTNEY: 0x00142771,
    RAC3LOCATION.NATION_NINJA_CHALLENGE: 0x0014277D,
    RAC3LOCATION.NATION_COUNTING_DUCKS: 0x0014277E,
    RAC3LOCATION.NATION_CYCLING_WEAPONS: 0x0014277F,
    RAC3LOCATION.NATION_ONE_HIT_WONDER: 0x00142780,
    RAC3LOCATION.NATION_TIME_TO_SUCK: 0x00142781,
    RAC3LOCATION.NATION_NAPTIME: 0x00142782,
    RAC3LOCATION.NATION_MORE_CYCLING_WEAPONS: 0x00142783,
    RAC3LOCATION.NATION_DODGE_THE_TWINS: 0x00142784,
    RAC3LOCATION.NATION_CHOP_CHOP: 0x00142785,
    RAC3LOCATION.NATION_SLEEP_INDUCER: 0x00142786,
    RAC3LOCATION.NATION_THE_OTHER_WHITE_MEAT: 0x00142787,
    RAC3LOCATION.NATION_CHAMPIONSHIP_BOUT_II: 0x00142788,
    RAC3LOCATION.NATION_QWARKTASTIC_BATTLE: 0x00142789,
    RAC3LOCATION.NATION_HEAT_STREET: 0x0014276E,
    RAC3LOCATION.NATION_CRISPY_CRITTER: 0x0014277A,
    RAC3LOCATION.NATION_PYRO_PLAYGROUND: 0x0014277B,
    RAC3LOCATION.NATION_SUICIDE_RUN: 0x0014277C,
    RAC3LOCATION.NATION_BBQ_BOULEVARD: 0x00142770,
    RAC3LOCATION.NATION_MAZE_OF_BLAZE: 0x0014278A,
    RAC3LOCATION.NATION_CREMATION_STATION: 0x0014278B,
    RAC3LOCATION.NATION_THE_ANNIHILATOR: 0x0014278C,

    RAC3LOCATION.TYHRRANOSIS_RANGERS_1: 0x0014274C,
    RAC3LOCATION.TYHRRANOSIS_RANGERS_2: 0x0014274D,
    RAC3LOCATION.TYHRRANOSIS_RANGERS_3: 0x0014274F,
    RAC3LOCATION.TYHRRANOSIS_RANGERS_4: 0x00142750,

    RAC3LOCATION.BLACKWATER_CITY_RANGERS_1: 0x0014273D,
    RAC3LOCATION.BLACKWATER_CITY_RANGERS_2: 0x0014273E,
    RAC3LOCATION.BLACKWATER_CITY_RANGERS_3: 0x00142741,

    RAC3LOCATION.METROPOLIS_RANGERS_1: 0x00142747,
    RAC3LOCATION.METROPOLIS_RANGERS_2: 0x00142748,
    RAC3LOCATION.METROPOLIS_RANGERS_3: 0x00142749,
    RAC3LOCATION.METROPOLIS_RANGERS_4: 0x0014274A,
    RAC3LOCATION.METROPOLIS_RANGERS_5: 0x0014274B,

    RAC3LOCATION.ARIDIA_RANGERS_1: 0x00142742,
    RAC3LOCATION.ARIDIA_RANGERS_2: 0x00142743,
    RAC3LOCATION.ARIDIA_RANGERS_3: 0x00142744,
    RAC3LOCATION.ARIDIA_RANGERS_4: 0x00142745,
    RAC3LOCATION.ARIDIA_RANGERS_5: 0x00142746,
}
