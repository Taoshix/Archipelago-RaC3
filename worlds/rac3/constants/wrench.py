...
from worlds.rac3.constants.region import WRENCH_FUNCTION_OFFSET_NTSC, WRENCH_FUNCTION_OFFSET_PAL
    ...
    def get_wrench_property_address(planet: str, game_id: str = '') -> int:
        ...
        match game_id:
            case RAC3VERSION.US_ID:
                addr = RAC3STATUS.WRENCH_FUNCTION_BASE_NTSC + WRENCH_FUNCTION_OFFSET_NTSC[planet]
                return addr
            case RAC3VERSION.EU_ID:
                addr = RAC3STATUS.WRENCH_FUNCTION_BASE_PAL + WRENCH_FUNCTION_OFFSET_PAL[planet]
                return addr
            case _:
                addr = RAC3STATUS.WRENCH_FUNCTION_BASE_NTSC + WRENCH_FUNCTION_OFFSET_NTSC[planet]
                return addr