...
class RaC3World(World):
    ...
    def handle_not_enough_locations(self, count):
        ...
        if self.options.vidcomic_health_upgrade.value == 0:
            option_list.append(RAC3OPTION.VIDCOMIC_HEALTH_UPGRADE)
    ...
    def fill_slot_data(self) -> dict[str, Any]:
        slot_data: dict[str, Any] = {
            ...
            RAC3OPTION.VIDCOMIC_HEALTH_UPGRADE: self.options.vidcomic_health_upgrade.value,
