...
class RaC3World(World):
    ...
    def fill_slot_data(self) -> dict[str, Any]:
        slot_data: dict[str, Any] = {
            ...
            RAC3OPTION.PLAYER_SKIN: self.options.player_skin.value,
            ...
            RAC3OPTION.LOCK_CC: self.options.lock_command_center,
            RAC3OPTION.GOAL_BIO: self.options.goal_bio,
            RAC3OPTION.GOAL_NEF: self.options.goal_nef,
            RAC3OPTION.GOAL_NANO: self.options.goal_nano,
            RAC3OPTION.GOAL_CRYSTAL: self.options.goal_crystal,
            RAC3OPTION.GOAL_TBOLTS: self.options.goal_tbolts,
            RAC3OPTION.GOAL_SKILLPOINTS: self.options.goal_skillpoints,
            RAC3OPTION.GOAL_QWARK: self.options.goal_qwark,
            RAC3OPTION.GOAL_MUSEUM: self.options.goal_museum,
            RAC3OPTION.GOAL_PLANETS: self.options.goal_planets,
            RAC3OPTION.GOAL_COMPLETION: self.options.goal_completion,
            RAC3OPTION.GOAL_BOSS_QWARK: self.options.goal_boss_qwark,
            RAC3OPTION.GOAL_BOSS_TWO: self.options.goal_boss_two,
            RAC3OPTION.GOAL_BOSS_NOID: self.options.goal_boss_noid,
            RAC3OPTION.GOAL_BOSS_WARSHIP: self.options.goal_boss_warship,
            RAC3OPTION.GOAL_BOSS_SCORPIO: self.options.goal_boss_scorpio,
            RAC3OPTION.GOAL_BOSS_TALOS: self.options.goal_boss_talos,
            RAC3OPTION.GOAL_BOSS_GEARS: self.options.goal_boss_gears,
            RAC3OPTION.GOAL_BOSS_KLUNK: self.options.goal_boss_klunk,
